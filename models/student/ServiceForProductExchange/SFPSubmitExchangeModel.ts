...
interface SFPSubmitExchangeSchemaInterface extends Document {
  title: string;
  offerType: string;
  category: string;
  subcategory: string;
...
// Define the schema
const SFPSubmitExchangeSchema = new Schema<SFPSubmitExchangeSchemaInterface>({
  ...
  materialConditions: {
    ...
    freeQuote: {
      ...
      feeAmount: {
        ...
        required: function (this: SFPSubmitExchangeSchemaInterface) {
          return this.materialConditions.freeQuote.freeQuote === "no";
        },
        set: function (this: SFPSubmitExchangeSchemaInterface, value: any) {
        ...
        validate: {
          validator: function (
            this: SFPSubmitExchangeSchemaInterface,
...
export { SFPSubmitExchangeSchema };

const SFPSubmitExchangeModel =
  mongoose.models.SFPSubmitExchangeSchema ||
  mongoose.model("SFPSubmitExchangeSchema", SFPSubmitExchangeSchema);

export default SFPSubmitExchangeModel;
