...
import ExpectedRequirements from "@/app/[locale]/dashboard/student/exchanges/serviceforproduct/component/ExpectedRequirements";
...
const MultiStepForm = () => {
  ...
  const submitExchangeFormDetails = async (mergedData: any) => {
    ...
    const response = await fetch(
      "/api/student/exchanges/serviceforproductexchange",
      {
        method: "POST",
