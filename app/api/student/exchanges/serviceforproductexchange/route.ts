import ServiceForProductExchangeModel from "@/models/student/ServiceForProductExchange/ServiceForProductExchangeModel";
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Save to MongoDB
    const newExchange = new ServiceForProductExchangeModel({
      submitExchangeDetails,
